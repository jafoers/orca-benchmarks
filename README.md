...
| 004 | [NiTPP, PdTPP, PtTPP B-band trend](benchmarks/004-ni-pd-pt-tpp-bband-trend/) | NiTPP, PdTPP, PtTPP, 77 atoms each | Full TD-DFT, def2-TZVP, CPCM(toluene) | The B band blue-shifts monotonically from Ni to Pd to Pt across the five-functionals sweep. |
